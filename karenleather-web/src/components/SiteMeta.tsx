...
import { absoluteUrl, siteBrand } from "../content/siteCopy";
import { useSeo } from "../context/SeoContext";
import { filterFromSlug, type ShopFilter } from "../lib/shop";
...
export function SiteMeta() {
  ...
  useEffect(() => {
    ...
    const canonical = absoluteUrl(`${pathname}${search || ""}`);
  ...
  }, [pathname, search, params, override, jsonLd]);
